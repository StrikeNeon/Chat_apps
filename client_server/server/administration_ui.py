...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.room_managemen_page = QtWidgets.QWidget()
        self.room_managemen_page.setObjectName("room_managemen_page")
        self.roomManager = QtWidgets.QTabWidget(self.room_managemen_page)
        self.roomManager.setGeometry(QtCore.QRect(20, 20, 751, 391))
        self.roomManager.setObjectName("roomManager")
        self.room_zero_tab = QtWidgets.QWidget()
        self.room_zero_tab.setObjectName("room_zero_tab")
        self.close_room_button = QtWidgets.QPushButton(self.room_zero_tab)
        self.close_room_button.setGeometry(QtCore.QRect(20, 200, 75, 23))
        self.close_room_button.setObjectName("close_room_button")
        self.room_num_lable = QtWidgets.QLabel(self.room_zero_tab)
        self.room_num_lable.setGeometry(QtCore.QRect(20, 20, 91, 16))
        self.room_num_lable.setObjectName("room_num_lable")
        self.user_counter_lable = QtWidgets.QLabel(self.room_zero_tab)
        self.user_counter_lable.setGeometry(QtCore.QRect(120, 20, 61, 16))
        self.user_counter_lable.setObjectName("user_counter_lable")
        self.user_counter = QtWidgets.QLCDNumber(self.room_zero_tab)
        self.user_counter.setGeometry(QtCore.QRect(120, 50, 64, 23))
        self.user_counter.setObjectName("user_counter")
        self.room_num_placeholder = QtWidgets.QLabel(self.room_zero_tab)
        ...
        self.room_load_display = QtWidgets.QProgressBar(self.room_zero_tab)
        ...
        self.label = QtWidgets.QLabel(self.room_zero_tab)
        self.label.setGeometry(QtCore.QRect(20, 90, 47, 13))
        self.label.setObjectName("label")
        self.log_box = QtWidgets.QTextBrowser(self.room_zero_tab)
        self.log_box.setGeometry(QtCore.QRect(220, 10, 511, 321))
        self.log_box.setObjectName("log_box")
        self.roomManager.addTab(self.room_zero_tab, "")
        self.db_reconnect_button = QtWidgets.QPushButton(self.room_managemen_page)
        ...
        self.roomManager.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
        self.close_room_button.setText(_translate("MainWindow", "close room"))
        self.room_num_lable.setText(_translate("MainWindow", "room_num"))
        self.user_counter_lable.setText(_translate("MainWindow", "users online"))
        self.room_num_placeholder.setText(_translate("MainWindow", "placeholder_num"))
        self.label.setText(_translate("MainWindow", "room load"))
        self.roomManager.setTabText(self.roomManager.indexOf(self.room_zero_tab), _translate("MainWindow", "Tab 1"))
